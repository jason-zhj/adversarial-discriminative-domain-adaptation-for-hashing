...
def run_pretrain(model_def, params):
    ...
    h = model_def.LeNetCodeGen(code_len=params.hash_size)
...
def run_testing(params, model_path, model_def):
    ...
    hash_model = model_def.get_hash_function(enc=models["enc"],h=models["h"])
...
def mnist_test_on_training_data():
    ...
    # }
    run_testing(model_def=model_def, params=params, model_path="saved_models/pretrain")
